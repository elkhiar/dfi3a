import { CalendarCheck2, Edit3, LogOut, MapPin, Save, Sparkles, Trophy } from 'lucide-react'
  ...
  return (
    <div className="pt-[max(0.5rem,env(safe-area-inset-top))]">
      ...
      <section className="mt-5 flex items-center gap-4">
        <span className="grid size-20 shrink-0 place-items-center rounded-[26px] bg-sky-500 text-2xl font-bold text-white">
      ...
      <section className="mt-6">
        ...
        {(draft.showInParticipants !== profile.showInParticipants || draft.showInLeaderboard !== profile.showInLeaderboard || draft.showCity !== profile.showCity) && (
